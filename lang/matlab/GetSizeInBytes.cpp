...
// mex -D_MEX_FILE_ GetSizeInBytes.cpp ../RTMA.cpp ../../LibCommon/PipeIO.c
// ../../LibCommon/NetworkLayer.c ../../LibCommon/MyCException.cpp
// ../../LibCommon/MyCString.cpp ../../LibCommon/DD.cpp
// ../../LibCommon/DDStream.cpp ws2_32.lib
    ...
    const mxArray *input_arg[]) // Array of right hand side arguments
{
  ...
  // char Filename[2048];
  // int i, j;
  // RTMA_MSG_HEADER *pMessageHeaders;

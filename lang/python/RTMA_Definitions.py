...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_RTMA_Definitions')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_RTMA_Definitions')
...
class RTMA_MSG_HEADER(_object):
    ...
    if _newclass:
        msg_type = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_msg_type_get, _RTMA_Definitions.RTMA_MSG_HEADER_msg_type_set)
    ...
    if _newclass:
        msg_count = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_msg_count_get, _RTMA_Definitions.RTMA_MSG_HEADER_msg_count_set)
    ...
    if _newclass:
        send_time = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_send_time_get, _RTMA_Definitions.RTMA_MSG_HEADER_send_time_set)
    ...
    if _newclass:
        recv_time = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_recv_time_get, _RTMA_Definitions.RTMA_MSG_HEADER_recv_time_set)
    ...
    if _newclass:
        src_host_id = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_src_host_id_get, _RTMA_Definitions.RTMA_MSG_HEADER_src_host_id_set)
    ...
    if _newclass:
        src_mod_id = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_src_mod_id_get, _RTMA_Definitions.RTMA_MSG_HEADER_src_mod_id_set)
    ...
    if _newclass:
        dest_host_id = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_dest_host_id_get, _RTMA_Definitions.RTMA_MSG_HEADER_dest_host_id_set)
    ...
    if _newclass:
        dest_mod_id = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_dest_mod_id_get, _RTMA_Definitions.RTMA_MSG_HEADER_dest_mod_id_set)
    ...
    if _newclass:
        num_data_bytes = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_num_data_bytes_get, _RTMA_Definitions.RTMA_MSG_HEADER_num_data_bytes_set)
    ...
    if _newclass:
        remaining_bytes = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_remaining_bytes_get, _RTMA_Definitions.RTMA_MSG_HEADER_remaining_bytes_set)
    ...
    if _newclass:
        is_dynamic = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_is_dynamic_get, _RTMA_Definitions.RTMA_MSG_HEADER_is_dynamic_set)
    ...
    if _newclass:
        reserved = _swig_property(_RTMA_Definitions.RTMA_MSG_HEADER_reserved_get, _RTMA_Definitions.RTMA_MSG_HEADER_reserved_set)
...
class RTMA_MESSAGE(_object):
    ...
    if _newclass:
        msg_type = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_msg_type_get, _RTMA_Definitions.RTMA_MESSAGE_msg_type_set)
    ...
    if _newclass:
        msg_count = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_msg_count_get, _RTMA_Definitions.RTMA_MESSAGE_msg_count_set)
    ...
    if _newclass:
        send_time = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_send_time_get, _RTMA_Definitions.RTMA_MESSAGE_send_time_set)
    ...
    if _newclass:
        recv_time = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_recv_time_get, _RTMA_Definitions.RTMA_MESSAGE_recv_time_set)
    ...
    if _newclass:
        src_host_id = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_src_host_id_get, _RTMA_Definitions.RTMA_MESSAGE_src_host_id_set)
    ...
    if _newclass:
        src_mod_id = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_src_mod_id_get, _RTMA_Definitions.RTMA_MESSAGE_src_mod_id_set)
    ...
    if _newclass:
        dest_host_id = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_dest_host_id_get, _RTMA_Definitions.RTMA_MESSAGE_dest_host_id_set)
    ...
    if _newclass:
        dest_mod_id = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_dest_mod_id_get, _RTMA_Definitions.RTMA_MESSAGE_dest_mod_id_set)
    ...
    if _newclass:
        num_data_bytes = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_num_data_bytes_get, _RTMA_Definitions.RTMA_MESSAGE_num_data_bytes_set)
    ...
    if _newclass:
        remaining_bytes = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_remaining_bytes_get, _RTMA_Definitions.RTMA_MESSAGE_remaining_bytes_set)
    ...
    if _newclass:
        is_dynamic = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_is_dynamic_get, _RTMA_Definitions.RTMA_MESSAGE_is_dynamic_set)
    ...
    if _newclass:
        reserved = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_reserved_get, _RTMA_Definitions.RTMA_MESSAGE_reserved_set)
    ...
    if _newclass:
        data = _swig_property(_RTMA_Definitions.RTMA_MESSAGE_data_get, _RTMA_Definitions.RTMA_MESSAGE_data_set)
...
class MDF_FAIL_SUBSCRIBE(_object):
    ...
    if _newclass:
        mod_id = _swig_property(_RTMA_Definitions.MDF_FAIL_SUBSCRIBE_mod_id_get, _RTMA_Definitions.MDF_FAIL_SUBSCRIBE_mod_id_set)
    ...
    if _newclass:
        reserved = _swig_property(_RTMA_Definitions.MDF_FAIL_SUBSCRIBE_reserved_get, _RTMA_Definitions.MDF_FAIL_SUBSCRIBE_reserved_set)
    ...
    if _newclass:
        msg_type = _swig_property(_RTMA_Definitions.MDF_FAIL_SUBSCRIBE_msg_type_get, _RTMA_Definitions.MDF_FAIL_SUBSCRIBE_msg_type_set)
...
class MDF_FAILED_MESSAGE(_object):
    ...
    if _newclass:
        dest_mod_id = _swig_property(_RTMA_Definitions.MDF_FAILED_MESSAGE_dest_mod_id_get, _RTMA_Definitions.MDF_FAILED_MESSAGE_dest_mod_id_set)
    ...
    if _newclass:
        reserved = _swig_property(_RTMA_Definitions.MDF_FAILED_MESSAGE_reserved_get, _RTMA_Definitions.MDF_FAILED_MESSAGE_reserved_set)
    ...
    if _newclass:
        time_of_failure = _swig_property(_RTMA_Definitions.MDF_FAILED_MESSAGE_time_of_failure_get, _RTMA_Definitions.MDF_FAILED_MESSAGE_time_of_failure_set)
    ...
    if _newclass:
        msg_header = _swig_property(_RTMA_Definitions.MDF_FAILED_MESSAGE_msg_header_get, _RTMA_Definitions.MDF_FAILED_MESSAGE_msg_header_set)
...
class MDF_CONNECT(_object):
    ...
    if _newclass:
        logger_status = _swig_property(_RTMA_Definitions.MDF_CONNECT_logger_status_get, _RTMA_Definitions.MDF_CONNECT_logger_status_set)
    ...
    if _newclass:
        daemon_status = _swig_property(_RTMA_Definitions.MDF_CONNECT_daemon_status_get, _RTMA_Definitions.MDF_CONNECT_daemon_status_set)
...
class MDF_FORCE_DISCONNECT(_object):
    ...
    if _newclass:
        mod_id = _swig_property(_RTMA_Definitions.MDF_FORCE_DISCONNECT_mod_id_get, _RTMA_Definitions.MDF_FORCE_DISCONNECT_mod_id_set)
...
class MDF_MODULE_READY(_object):
    ...
    if _newclass:
        pid = _swig_property(_RTMA_Definitions.MDF_MODULE_READY_pid_get, _RTMA_Definitions.MDF_MODULE_READY_pid_set)
...
class MDF_SLAVE_START_APP_ACK(_object):
    ...
    if _newclass:
        num_remote_hosts = _swig_property(_RTMA_Definitions.MDF_SLAVE_START_APP_ACK_num_remote_hosts_get, _RTMA_Definitions.MDF_SLAVE_START_APP_ACK_num_remote_hosts_set)
...
class MDF_TIMER_EXPIRED(_object):
    ...
    if _newclass:
        timer_id = _swig_property(_RTMA_Definitions.MDF_TIMER_EXPIRED_timer_id_get, _RTMA_Definitions.MDF_TIMER_EXPIRED_timer_id_set)
...
class MDF_SET_TIMER_FAILED(_object):
    ...
    if _newclass:
        mod_id = _swig_property(_RTMA_Definitions.MDF_SET_TIMER_FAILED_mod_id_get, _RTMA_Definitions.MDF_SET_TIMER_FAILED_mod_id_set)
    ...
    if _newclass:
        timer_id = _swig_property(_RTMA_Definitions.MDF_SET_TIMER_FAILED_timer_id_get, _RTMA_Definitions.MDF_SET_TIMER_FAILED_timer_id_set)
    ...
    if _newclass:
        snooze_time = _swig_property(_RTMA_Definitions.MDF_SET_TIMER_FAILED_snooze_time_get, _RTMA_Definitions.MDF_SET_TIMER_FAILED_snooze_time_set)
...
class MDF_SET_TIMER(_object):
    ...
    if _newclass:
        timer_id = _swig_property(_RTMA_Definitions.MDF_SET_TIMER_timer_id_get, _RTMA_Definitions.MDF_SET_TIMER_timer_id_set)
    ...
    if _newclass:
        snooze_time = _swig_property(_RTMA_Definitions.MDF_SET_TIMER_snooze_time_get, _RTMA_Definitions.MDF_SET_TIMER_snooze_time_set)
...
class MDF_CANCEL_TIMER(_object):
    ...
    if _newclass:
        timer_id = _swig_property(_RTMA_Definitions.MDF_CANCEL_TIMER_timer_id_get, _RTMA_Definitions.MDF_CANCEL_TIMER_timer_id_set)
...
class MDF_SAVE_MESSAGE_LOG(_object):
    ...
    if _newclass:
        pathname = _swig_property(_RTMA_Definitions.MDF_SAVE_MESSAGE_LOG_pathname_get, _RTMA_Definitions.MDF_SAVE_MESSAGE_LOG_pathname_set)
    ...
    if _newclass:
        pathname_length = _swig_property(_RTMA_Definitions.MDF_SAVE_MESSAGE_LOG_pathname_length_get, _RTMA_Definitions.MDF_SAVE_MESSAGE_LOG_pathname_length_set)
...
class MDF_TIMING_MESSAGE(_object):
    ...
    if _newclass:
        timing = _swig_property(_RTMA_Definitions.MDF_TIMING_MESSAGE_timing_get, _RTMA_Definitions.MDF_TIMING_MESSAGE_timing_set)
    ...
    if _newclass:
        ModulePID = _swig_property(_RTMA_Definitions.MDF_TIMING_MESSAGE_ModulePID_get, _RTMA_Definitions.MDF_TIMING_MESSAGE_ModulePID_set)
    ...
    if _newclass:
        send_time = _swig_property(_RTMA_Definitions.MDF_TIMING_MESSAGE_send_time_get, _RTMA_Definitions.MDF_TIMING_MESSAGE_send_time_set)
...
class DoubleArray(_object):
    ...
    def __init__(self, nelements):
        this = _RTMA_Definitions.new_DoubleArray(nelements)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def __getitem__(self, index):
        return _RTMA_Definitions.DoubleArray___getitem__(self, index)

    def __setitem__(self, index, value):
        return _RTMA_Definitions.DoubleArray___setitem__(self, index, value)

    def cast(self):
        return _RTMA_Definitions.DoubleArray_cast(self)
    if _newclass:
        frompointer = staticmethod(_RTMA_Definitions.DoubleArray_frompointer)
    else:
        frompointer = _RTMA_Definitions.DoubleArray_frompointer
DoubleArray_swigregister = _RTMA_Definitions.DoubleArray_swigregister
DoubleArray_swigregister(DoubleArray)

def DoubleArray_frompointer(t):
    return _RTMA_Definitions.DoubleArray_frompointer(t)
...
class UcharArray(_object):
    ...
    def __init__(self, nelements):
        this = _RTMA_Definitions.new_UcharArray(nelements)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def __getitem__(self, index):
        return _RTMA_Definitions.UcharArray___getitem__(self, index)

    def __setitem__(self, index, value):
        return _RTMA_Definitions.UcharArray___setitem__(self, index, value)

    def cast(self):
        return _RTMA_Definitions.UcharArray_cast(self)
    if _newclass:
        frompointer = staticmethod(_RTMA_Definitions.UcharArray_frompointer)
    else:
        frompointer = _RTMA_Definitions.UcharArray_frompointer
...
def UcharArray_frompointer(t):
    return _RTMA_Definitions.UcharArray_frompointer(t)

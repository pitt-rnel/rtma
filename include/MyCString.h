...
using namespace std;
#define itoa                                                                   \
  _itoa // use ISO name for itoa (deprecated) - also note, most 'c' string
...
constexpr auto CSTRING_IN_BUFFER =
    100; // buffer size for >> operator overloading & for other internal
         // operations
